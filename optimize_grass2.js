...
let heavenCode = fs.readFileSync('src/client/controllers/environment/HeavenEnvironmentController.lua', 'utf8');
...
fs.writeFileSync('src/client/controllers/environment/HeavenEnvironmentController.lua', heavenCode);
...
let newUpdateBlades = `function GrassGrid:_updateBlades(dt: number, playerPos: Vector3)
    ...
    console.log("Could not find _updateBlades to replace");
}
