const fs = require('fs');
let code = fs.readFileSync('src/client/controllers/HeavenEnvironmentController.lua', 'utf8');

const replacement = `--!strict
...
fs.writeFileSync('src/client/controllers/HeavenEnvironmentController.lua', replacement);
