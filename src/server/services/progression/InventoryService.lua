...
local AbilitySystem = require(script.Parent.Parent.abilities.AbilitySystem)
local NetworkProvider = require(ReplicatedStorage.Shared.network.NetworkProvider)
local NetworkService = require(script.Parent.Parent.core.NetworkService)
...
function InventoryService.UseItem(player: Player, itemId: string, target: Player?)
    ...
    if item.Category == "Tools" then
        ...
        local TrainingToolService = require(script.Parent.Parent.utility.TrainingToolService)
