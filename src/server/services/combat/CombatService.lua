...
function CombatService:Start()
	...
	AbilitySystem     = require(script.Parent.Parent.abilities.AbilitySystem)
	WeaponService     = require(script.Parent.WeaponService)
	PostureService    = require(script.Parent.PostureService)
	ProgressionService = require(script.Parent.Parent.progression.ProgressionService)
	HollowedService   = require(script.Parent.Parent.progression.HollowedService)
	StateSyncService  = require(script.Parent.Parent.core.StateSyncService)
