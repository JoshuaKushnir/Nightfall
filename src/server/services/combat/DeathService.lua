...
local function _requireDataService()
    if not _DataService then
        _DataService = require(ServerScriptService.Server.services.core.DataService)
    end
    return _DataService
end
...
local function _requireCombatService()
    if not _CombatService then
        _CombatService = require(ServerScriptService.Server.services.combat.CombatService)
    end
